...
<%= Html.ResortNavigation(Model.Resort, "videos")%>
...
<div class="container_12">
    ...
    <div class="grid_7">
        ...
        <div class="pod">
            <div class="podIn">
                <div id="targetVideos" style="padding: 10px 0 0 10px;"></div>
                <div class="cb"></div>
            </div>
            <div class="podbtm">
                <a href="#" title="">View on Map &rarr;</a> 
            </div>
        </div>
    </div>
    <div class="grid_2">
...
<asp:Content ID="Scripts" ContentPlaceHolderID="ContentScripts" runat="server">
    ...
    function storeYouTubeThumbs(youtube) {
        ...
        if (entries.length == 0) {
            ...
            target.innerHTML = "";
            var l = (entries.length > 4) ? 4 : entries.length;
            for (var i = 0; (i < l); i++) {
                var video = entries[i];
            ...
            sporthub.utility.qTipInit("div#targetVideos");
        }
    }
