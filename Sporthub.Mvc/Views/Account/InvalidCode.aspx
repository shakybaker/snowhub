    ...
    <div class="container_12" style="margin-top: 20px;">
        ...
        <div class="grid_6">
            ...
            <div class="pod">
                ...
                <br />
                <p>The link you used to activate your account was invalid, did you copy it correctly?</p>
                <p>Maybe you are already activated?</p>
                <p>You can try to <a href="/account/login">log in</a>, we can send you a <a href="/account/forgotpassword">password reminder</a>, or we can send you another activation email below: -</p>
                <p>
                <form class="resendEmailForm" action="<%= Url.Action("InvalidCode", "Account") %>" method="post">
