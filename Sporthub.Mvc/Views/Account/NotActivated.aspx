    ...
    <div class="container_12" style="margin-top: 20px;">
        ...
        <div class="grid_6">
            ...
            <div class="pod">
                ...
                <br />
                <p>You need to 'activate' your account before you can start using it.</p>
                <p>When you signed-up we sent you an email with an activation link. Check your email (and spam folder) for an email from us or we can send you another below: -</p>
                <p>
                <form class="resendEmailForm" action="<%= Url.Action("ResendEmail", "Account") %>" method="post">
                    <%= Html.TextBox("Email", Model.User.Email, new { @class = "tb tb200" })%><span id="f_Email" class="f"></span><span id="m_Email" class="m"></span>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBrowserTitle" runat="server">Snowhub : Account not activated</asp:Content>
