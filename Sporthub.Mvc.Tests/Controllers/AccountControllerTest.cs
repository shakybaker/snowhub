...
using Sporthub.Mvc;
using Sporthub.Mvc.Controllers;

namespace Sporthub.Mvc.Tests.Controllers {
    ...
    public class AccountControllerTest {
        ...
        public void RegisterPostReturnsViewIfRegistrationFails() {
            ...
            // Act
            ViewResult result = (ViewResult)controller.Register("someUser", "DuplicateUserName", "badPass", "badPass");
